...
hashiApp.controller('PostAdSaleUnitsController', function($scope, $state, auth,categoryFactory,
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertySaleUnits', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
