...
hashiApp.controller('PostAdSaleCommercialController', function($scope, $state, auth,categoryFactory,
		...
		$http,$timeout, ownerTypeEnglish, ownerTypeSomali) {
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertySaleComm', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
