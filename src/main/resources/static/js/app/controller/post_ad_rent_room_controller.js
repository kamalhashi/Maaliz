...
hashiApp.controller('PostAdRentRoomController', function($scope, $state, auth,categoryFactory,
		...
		$http,$timeout, noBathroomsEnglish, noBathroomsSomali, 
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertyRentRoom', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
