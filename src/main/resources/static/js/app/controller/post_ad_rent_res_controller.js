...
hashiApp.controller('PostAdRentResidentialController', function($scope, $state, auth,categoryFactory,
		...
		noBedroomsApartmentSomali, noBedroomsApartmentEnglish, noBathroomsEnglish, noBathroomsSomali, 
		ownerTypeEnglish, ownerTypeSomali, rentTimeSomali, rentTimeEnglish, furnishedEnglish, furnishedSomali) {
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertyRentRes', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
