...
hashiApp.controller('PostAdSaleResidentialController', function($scope, $state, auth,categoryFactory,
		...
		ownerTypeEnglish, ownerTypeSomali) {
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertySaleRes', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
