...
hashiApp.controller('PostAdRentCommercialController', function($scope, $state, auth,categoryFactory,
		...
		$http,$timeout, ownerTypeEnglish, ownerTypeSomali, rentTimeSomali, 
		rentTimeEnglish, furnishedEnglish, furnishedSomali) {
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertyRentComm', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
