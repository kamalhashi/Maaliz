...
hashiApp.controller('PostAdRentHotelsController', function($scope, $state, auth,categoryFactory,
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertyRentHotel', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
