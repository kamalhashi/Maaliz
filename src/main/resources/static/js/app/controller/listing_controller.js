...
hashiApp.controller('ListingController', function($scope, $http, productFactory, $stateParams, $state, categoryRange, bucketName,
	...
	$scope.search = function() {	
	    ...
	    $state.go('.', {searchType:$scope.searchType , selectedCityId : $scope.selectedCityId, finalSelectedCategoryId:  $scope.finalSelectedCategoryId, 
			selectedCategoryIdLevelOne:  $scope.categoryLevelOneObject.categoryId,
			selectedCategoryIdLevelTwo:  $scope.categoryLevelTwoObject == null ? null : $scope.categoryLevelTwoObject.categoryId,
			selectedCategoryIdLevelThree: $scope.categoryLevelThreeObject == null ? null : $scope.categoryLevelThreeObject.categoryId  ,
			selectedCategoryIdLevelFour:  $scope.categoryLevelFourObject == null ? null : $scope.categoryLevelFourObject.categoryId,
