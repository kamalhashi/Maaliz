...
hashiApp.controller('PostAdClassifiedPetsController', function($scope, $state, auth,categoryFactory,
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'Product', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
