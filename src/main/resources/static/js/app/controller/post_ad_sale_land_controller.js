...
hashiApp.controller('PostAdSaleLandController', function($scope, $state, auth,categoryFactory,
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'PropertySaleLand', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
