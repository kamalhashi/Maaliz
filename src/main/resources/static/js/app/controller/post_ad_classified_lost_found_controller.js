...
hashiApp.controller('PostAdClassifiedLostFoundController', function($scope, $state, auth,categoryFactory,
	...
	(function init() {
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'ClassifiedLostFound', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
