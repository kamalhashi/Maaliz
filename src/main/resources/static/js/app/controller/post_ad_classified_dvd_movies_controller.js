...
hashiApp.controller('PostAdClassifiedDvdMoviesController', function($scope, $state, auth,categoryFactory,
		...
		$http,$timeout,conditionSomali, conditionEnglish, dvdRating,
	...
	(function init() {
		...
		$scope.constantDvdRating= dvdRating;
		...
		//for edit page product, first load the productId
		...
		/********only specific for the new product**********/
			...
			$scope.ad= {type: 'ClassifiedDvdMovies', productPriority: 0, imageStatus: 'IMAGE_PENDING'};
